...
public class FilteringByProductTest extends BaseFuncTest {
    ...
    public void changeSelectedProduct() {
        ...
        Result<ProductInfo> result = tmUiOperator.selectUserProfileProduct(productInfo);
        ...
        CustomAsserts.checkTestStep(tmUiOperator.selectUserProfileProduct(ProductType.ASSURE.getProductInfo()));
    ...
    public void productIsPersisted() {
        ...
        Result<ProductInfo> productResult = tmUiOperator.getSelectedProject();
