package com.ericsson.cifwk.tm.fun.ui.userinbox;
...
public class AssignmentsTest extends BaseFuncTest {
    ...
    public void getAssignments() {
        ...
        Result<Paginated<TestCampaignItemInfo>> assignmentsPageResult = tmUiOperator.getCurrentUserAssignments(filters);
