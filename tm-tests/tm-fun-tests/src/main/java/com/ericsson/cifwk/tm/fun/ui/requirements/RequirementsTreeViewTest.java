package com.ericsson.cifwk.tm.fun.ui.requirements;
...
public class RequirementsTreeViewTest extends BaseFuncTest {
    ...
    public void showTestCasesByRequirement() {
        ...
        TestCasesResult result = tmUiOperator.getTestCasesByRequirement("Cip-4960");
    ...
    public void showByRequirementWithoutTestCases() {
        ...
        TestCasesResult result = tmUiOperator.getTestCasesByRequirement("CIP-4183");
        CustomAsserts.checkTestStep(result);
        assertNotNull(result.getTestCases());
    ...
    public void tryToSelectNotListedRequirement() {
        ...
        TestCasesResult result = tmUiOperator.getTestCasesByRequirement("CIP-NotFound");
    ...
    @Test
    @TestId(id="DURACI-2968_Func_4", title="Select a Test Case from Details block and return back to requirements")
    public void checkBackNavigationFromTestCase() {
        createUiOperators();
        ...
        CustomAsserts.checkTestStep(tmUiOperator.navigateToTestCaseFromRequirementsAndBack(result.getTestCases().get(0)));
