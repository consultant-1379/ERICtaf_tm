...
import com.ericsson.cifwk.tm.domain.model.users.impl.UserSessionRepositoryImpl;
import com.google.inject.ImplementedBy;

import java.util.List;

@ImplementedBy(UserSessionRepositoryImpl.class)
public interface UserSessionRepository extends BaseRepository<UserSession, Long> {

    UserSession findBySessionId(String sessionId);

    UserSession findActiveSessionId(String sessionId);
