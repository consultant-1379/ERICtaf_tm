...
public class StringParamFilter extends AbstractParamFilter<String> implements ParamFilter<String> {

    public StringParamFilter(String name, FilterSupplier<String> filterSupplier) {
