...
(24, 0, 2, 'Jira Status check, TEST DATA', '4 requirements assigned', 2, 'Test', 'MEDIUM', 1, 1, 23, 2, 'testDefaultTest', 'FUNCTIONAL'),
(25, 0, 2, 'Jira Status check, TEST DATA', '3 requirements assigned', 2, 'Test', 'MEDIUM', 2, 1, 24, 2, 'testDefaultTest', 'FUNCTIONAL');
...
(8, 0, 'CIP-8888', NULL, NULL, 'Story', 'CIP-8888', 'Jira Status check, TEST DATA', 2, NULL);
