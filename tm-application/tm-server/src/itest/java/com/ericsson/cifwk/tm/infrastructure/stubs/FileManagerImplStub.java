...
public class FileManagerImplStub implements FileManager {

    private static final Logger LOGGER = LoggerFactory.getLogger(FileManagerImplStub.class);
    ...
    @Inject
    public FileManagerImplStub(StorageConfiguration configuration) {
